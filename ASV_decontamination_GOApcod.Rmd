...
this script "decontaminates" the ASVs and sample reads from the mifish libraries (May 9 2023 and May 12 2023) that inclded samples from the GOA pcod survey in 2021  
...
ASV73 = Homo sapien so we'll remove all of this one any ways... 
